...
mmode_start:
        ...
        #
        # [0,100) - No access (locked)
        # [0,1000'0000) - RW in M mode only (locked)
        # [0,8000'0000) - RW in M or S mode
        # [8000'0000,8800'0000) - RWX in M and S mode (RAM)
        #
        
        li      t0, (0>>2) | ((0x100>>3)-1)
        csrw    pmpaddr0, t0
        li      t0, (0>>2) | ((0x10000000>>3)-1)
        csrw    pmpaddr1, t0
        ...
        # pmpcfg3 = 0'00'11'111 (U,NAPOT,RWX)
        # pmpcfg2 = 0'00'11'011 (U,NAPOT,RW)
